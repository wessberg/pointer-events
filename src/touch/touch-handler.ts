...
function handleDynamicPropertiesForNoContactTouch (pointerId: number, type: PointerEventType, touch: Touch, e: TouchEvent): { [Key in DynamicPointerEventProperty]: PropertyDescriptor } {
	return {
		...
		target: {
			value: getTouchTarget(pointerId, type, e, touch), ...SHARED_DESCRIPTOR_OPTIONS
		},
		...
		width: {
			value: POINTER_EVENT_DEFAULT_VALUES.width, ...SHARED_DESCRIPTOR_OPTIONS
		},
		height: {
			value: POINTER_EVENT_DEFAULT_VALUES.height, ...SHARED_DESCRIPTOR_OPTIONS
		},
		pressure: {
			value: POINTER_EVENT_DEFAULT_VALUES.pressure, ...SHARED_DESCRIPTOR_OPTIONS
		},
		tangentialPressure: {
			value: POINTER_EVENT_DEFAULT_VALUES.tangentialPressure, ...SHARED_DESCRIPTOR_OPTIONS
		},
		tiltX: {
			value: POINTER_EVENT_DEFAULT_VALUES.tiltX, ...SHARED_DESCRIPTOR_OPTIONS
		},
		tiltY: {
			value: POINTER_EVENT_DEFAULT_VALUES.tiltY, ...SHARED_DESCRIPTOR_OPTIONS
		},
		twist: {
			value: POINTER_EVENT_DEFAULT_VALUES.twist, ...SHARED_DESCRIPTOR_OPTIONS
		},
		layerX: {
			value: 0, ...SHARED_DESCRIPTOR_OPTIONS
		},
 ...
 * @returns {{[Key in DynamicPointerEventProperty]: PropertyDescriptor}}
 */
function handleDynamicPropertiesForContactTouch (pointerId: number, type: "pointerdown"|"pointermove"|"pointerover"|"pointerenter"|"pointerup"|"gotpointercapture"|"lostpointercapture", currentTouch: Touch, e: TouchEvent): { [Key in DynamicPointerEventProperty]: PropertyDescriptor } {
	...
	return {
		target: {
			value: getTouchTarget(pointerId, type, e, currentTouch), ...SHARED_DESCRIPTOR_OPTIONS
		},
		...
		clientX: {
			value: currentTouch.clientX, ...SHARED_DESCRIPTOR_OPTIONS
		},

		clientY: {
			value: currentTouch.clientY, ...SHARED_DESCRIPTOR_OPTIONS
		},

		screenX: {
			value: currentTouch.screenX, ...SHARED_DESCRIPTOR_OPTIONS
		},

		screenY: {
			value: currentTouch.screenY, ...SHARED_DESCRIPTOR_OPTIONS
		},

		pageX: {
			value: currentTouch.pageX, ...SHARED_DESCRIPTOR_OPTIONS
		},

		pageY: {
			value: currentTouch.pageY, ...SHARED_DESCRIPTOR_OPTIONS
		},
		...
		offsetX: {
			value: offsetX, ...SHARED_DESCRIPTOR_OPTIONS
		},

		offsetY: {
			value: offsetY, ...SHARED_DESCRIPTOR_OPTIONS
		},

		layerX: {
			value: layerX, ...SHARED_DESCRIPTOR_OPTIONS
		},

		layerY: {
			value: layerY, ...SHARED_DESCRIPTOR_OPTIONS
		},
		...
		width: {
			value: getTouchWidth(currentTouch), ...SHARED_DESCRIPTOR_OPTIONS
		},
		height: {
			value: getTouchHeight(currentTouch), ...SHARED_DESCRIPTOR_OPTIONS
		},
		...
		// https://www.w3.org/TR/pointerevents/#pointerevent-interface
		pressure: {
			value: getPressure(type, currentTouch), ...SHARED_DESCRIPTOR_OPTIONS
		},
		...
		// https://www.w3.org/TR/pointerevents/#pointerevent-interface
		twist: {
			value: getTouchTwist(currentTouch), ...SHARED_DESCRIPTOR_OPTIONS
		}
	};
}
...
function handleTouchAction (_type: PointerEventType, e: TouchEvent): void {
	...
	if (canPanX && canPanY) {
		...
		if (hasPanUpAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-x pan-up"});
		}

		else if (hasPanDownAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-x pan-down"});
		}
		...
		if (hasPanLeftAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-y pan-left"});
		}

		else if (hasPanRightAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-y pan-right"});
		}
		...
		if (hasPanLeftAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-up pan-left"});
		}

		else if (hasPanRightAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-up pan-right"});
		}
	}

	else if (hasPanDownAncestor) {
		if (hasPanLeftAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-down pan-left"});
		}

		else if (hasPanRightAncestor) {
			Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-down pan-right"});
		}
	}
		...
		Object.defineProperty(e, TOUCH_ACTION_PROPERTY_NAME, {value: "pan-right"});
	}
